...
Module Prevent
    ...
    Public Sub Prevent(ByVal g As Graphics, ByVal w As Integer, ByVal h As Integer)
        txt = Convert.FromBase64String("V29ycmF3dXQgMDA3NTY3") '.Replace("%20", " ")
        ...
        Dim txtSize As SizeF = g.MeasureString(System.Text.Encoding.UTF8.GetString(txt).Replace("%20", " "), New Font("Arial", 8))
...
Class ascProgressBar
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim mainRect As New Rectangle(12, midY - 4, Width - 25, 7) 'Height ascProgressBar 7
        Dim mainPath As GraphicsPath = RoundRect(mainRect, slope)
        ...
        Dim barRect As New Rectangle(12, midY - 4, CInt(((Width / _Maximum) * _Value) - ((_percent - 1) / 4)), 7) 'Height ascProgressBar 7
